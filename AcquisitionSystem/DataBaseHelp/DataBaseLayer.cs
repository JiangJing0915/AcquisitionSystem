...
namespace AcquisitionSystem.DataBaseHelp
{  /**//// <summary>
       /// All rights reserved
       /// 数据访问基础类
       /// 用户可以修改满足自己项目的需要。
    ...
    public class DataBaseLayer
    {
        ...
        public DataBaseLayer(string sql)
        {
        ...
        public SqlDataReader ExecuteImage(string sqlString)
        {
            SqlConnection iConn = this.GetSqlConnection();

            // using (SqlConnection  iConn = this.GetSqlConnection())
            {
                iConn.Open();
                SqlDataReader reader = null;
                try
                {
                    SqlCommand cmd = new SqlCommand(sqlString, iConn);
